"""
Django settings for mansiri project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-%_qwr7nq#2o-4$s%jww#0^uu5yar6q=9+bf4k#_581n07o(f2$')
...
WSGI_APPLICATION = 'mansiri.wsgi.application'
